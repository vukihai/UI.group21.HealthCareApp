...
public class SmartAlarmWelcomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_smart_alarm_welcome);
    ...
    private void launchHomeScreen() {
        Intent i = new Intent(this, SmartAlarmActivity.class);
        startActivity(i);
        finish();
    }
