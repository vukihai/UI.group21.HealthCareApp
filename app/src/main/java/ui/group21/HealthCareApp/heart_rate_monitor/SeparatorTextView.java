...
//      int w = c.getWidth();
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs == null) {
            ...
            TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.SeparatorTextView, 0, 0);

            final int N = a.getIndexCount();
            for (int i = 0; i < N; i++) {
                int attr = a.getIndex(i);
                switch (attr) {
                    case R.styleable.SeparatorTextView_dividerResId:
                    ...
                    case R.styleable.SeparatorTextView_dividerTextPadding:
                    ...
                    case R.styleable.SeparatorTextView_dividerHeight:
                    ...
                    case R.styleable.SeparatorTextView_dividerColor:
